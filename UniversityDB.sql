...
CREATE TABLE `COSTS` (
  ...
  PRIMARY KEY (`costID`, `universityID`),
...
CREATE TABLE `TUITION` (
  ...
  `inStateTuition` DECIMAL(8,2) NOT NULL,
  `outOfStateTuition` DECIMAL(8,2) NOT NULL,
  `costsID` INT NOT NULL,
  PRIMARY KEY (`tuitionID`, `costsID`),
...
INSERT INTO `TUITION`
(`tuitionID`, `inStateTuition`, `outOfStateTuition`, `costsID`)
VALUES
